  ...
  return (
    <li className="flex flex-col items-start">
      <a
        ...
        rel="noreferrer"
        className="hocus:pointer group w-full flex-col overflow-hidden rounded-lg bg-neutral-100 shadow-md ring-1 ring-neutral-200 transition-colors hocus:bg-neutral-200 dark:bg-neutral-800 dark:ring-neutral-700 hocus:dark:bg-neutral-700"
      >
