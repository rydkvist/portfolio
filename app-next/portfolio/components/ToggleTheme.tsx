...
export const ToggleTheme = () => {
  ...
  return (
    <button
      ...
      onClick={onToggle}
      title={label}
      className="rounded-lg bg-neutral-100 p-2.5 text-sm text-neutral-500 transition-all ease-in-out hover:bg-neutral-50 active:scale-95 dark:bg-neutral-700 dark:text-neutral-400 dark:hover:bg-neutral-600"
    >
...
const SunIcon = () => (
  <svg className="h-5 w-5 md:h-4 md:w-4" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
