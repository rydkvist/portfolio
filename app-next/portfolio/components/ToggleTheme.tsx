...
export const ToggleTheme = () => {
  ...
  return (
    <button
      ...
      onClick={onToggle}
      title={label}
      className="hocus:bg-neutral-50 dark:hocus:bg-neutral-600 rounded-lg bg-neutral-100 p-2.5 text-sm text-neutral-500 transition-all ease-in-out active:scale-95 dark:bg-neutral-700 dark:text-neutral-400"
    >
