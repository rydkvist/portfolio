  ...
  <PageWrapper>
    <>
      ...
      <p className="text-neutral-700 dark:text-neutral-300 mr-auto mb-8">
        ...
        more. I love paying attention to detail and always strive to deliver the best user experience (UX/UI) possible,
      ...
      <p className="italic text-neutral-700 dark:text-neutral-300 mr-auto mb-8">
