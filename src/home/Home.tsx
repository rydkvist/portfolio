    ...
    <>
      <div className="container max-w-screen-lg mx-auto">
        <div className="flex flex-col justify-center items-center px-8">
          ...
          <h3
            className="text-2xl mt-4 md:mt-2 w-full text-left md:text-center font-light leading-relaxed"
            style={{ fontFamily: "Lato" }}
          >
            I'm a passionate self-taught{" "}
            <span className="font-medium">software developer</span> from Sweden
            specializing in{" "}
            <span className="font-medium">front-end development</span>, creating
            professional web applications and design systems.
            <br />
